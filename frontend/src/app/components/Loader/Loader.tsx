...

            {
                ...
                <div className={clsx(
                    ...
                    <div className={clsx(
                        ...
                        (!showLogoAnimation && !showLoaderAnimation) ? "w-12 h-12 top-0 left-0 disppear-loader": "left-[calc(50%-75px)] top-[calc(50%-50px)]  w-[150px] h-[100px] "   // 64px == height of the navbar    
