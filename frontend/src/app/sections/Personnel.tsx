    ...
    return (
        <section className="h-[calc(85vh)] md:h-screen mx-auto">
            <div className="flex flex-row items-start md:items-center justify-around  mt-[84px] h-[calc(100%-84px)]  ">
                <div className="flex-1 flex flex-col gap-[20px]  items-start  justify-center  mx-w-[1200px] h-full">
                    ...
                    <h1 className="text-lightest-slate text-4xl md:text-8xl lg:text-12xl font-bold opacity-0 animate-fade-in-bottom animation-delay-[400ms] ">Yanis Tabellout.</h1>
                    <h2 className="text-slate text-4xl md:text-8xl lg:text-12xl font-bold opacity-0 animate-fade-in-bottom animation-delay-[700ms]">Passionate about computers.</h2>
