...
function Personnel({}:PersonnelProps) {
    return (
        <section id="hero" className="min-h-screen h-full md:h-screen mx-auto ">
            <div className="flex flex-row items-start md:items-center justify-around  mt-[84px] min-h-[calc(100%-84px)]">
